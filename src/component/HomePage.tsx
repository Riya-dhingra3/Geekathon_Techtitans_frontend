...
const Home: React.FC = () => {
  ...
  const totalPages = Math.ceil((sortedAndFilteredRepos?.length || 0) / ITEMS_PER_PAGE);
      ...
      <div className="min-h-[100vh] w-[100%] bg-[#161B21] px-[5%] relative">
        ...
        <div className="flex flex-col h-fit w-full bg-[#1D232C]/3 backdrop-blur-lg rounded-[8px] border-[1px] border-[#FFFFFF]/20 overflow-hidden">
          <div className="flex flex-row w-full bg-[#1D232C] p-4">
            ...
            <div className="font-semibold text-[18px] text-[#EEF0F4] flex-1">Language</div>
            <div className="font-semibold text-[18px] text-[#EEF0F4] flex-1">Status</div>
            <div className="font-semibold text-[18px] text-[#EEF0F4] flex-1">Forks</div>
            <div className="font-semibold text-[18px] text-[#EEF0F4] flex-1">Watchers</div>
            <div className="font-semibold text-[18px] text-[#EEF0F4] flex-1">Date</div>
          </div>
          {paginatedRepos?.map((repo) => (
            ...
            >
              ...
              <div className="flex items-center flex-1">
                <div className={`bg-[#FFFFFF]/15 rounded-[9px] px-2 py-1 w-fit flex   text-[14px] ${colorDetermine(repo.visibility)}`}>
                  {repo.visibility}
                </div>
              </div>
